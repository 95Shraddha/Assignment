...
public class Runner {
	public static void main(String[] args) throws Exception {
		...
		driver.manage().window().maximize(); FirstScenario firstScenario = new
		FirstScenario(driver); firstScenario.executeFirstScenario("iPhone Se");
		firstScenario.IncreaseFlipKartQuantity(); firstScenario.PrintPriceinCart();
